...
class TestAmenity(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """To test that Amenity is a subclass of BaseModel"""
        amenity = Amenity()
    ...
    def test_name_attr(self):
        """To test that Amenity has attribute name, and it's as an empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_values(self):
        """to test that values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """it tests that the str method has the correct output"""
        amenity = Amenity()
